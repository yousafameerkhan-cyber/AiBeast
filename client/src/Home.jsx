...
const AdBanner = ({ adKey, width, height }) => {
  ...
  useEffect(() => {
    if (bannerRef.current && !bannerRef.current.firstChild) {
      ...
      confScript.innerHTML = `atOptions = { 'key' : '${adKey}', 'format' : 'iframe', 'height' : ${height}, 'width' : ${width}, 'params' : {} };`;
...
const Home = ({ setActiveTool }) => {
  ...
  const adKeys = [
    'd3c0fd21efdb64029cb87ff0f0d28ea8', // Rectangle 300x250
    'd115e550e46c09cfe291ed49e0e2fa9e', // Banner 468x60
    'e8ae945dd284baf5462fc3a497f1cad3'  // Banner 320x50
  ];
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
        {tools.map((tool, index) => (
          <React.Fragment key={tool.id}>
            ...
            {index < adKeys.length && (
              <AdBanner adKey={adKeys[index]} width={300} height={250} />
            )}
          </React.Fragment>
        ))}
      </div>
